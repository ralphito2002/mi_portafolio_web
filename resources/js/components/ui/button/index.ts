...
export const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*=\'size-\'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
  {
    variants: {
      variant: {
        default:
          'bg-turquesaBtnBg text-turquesaBtnText text-xl font-semibold py-2 px-4 border-2 border-turquesaBtnBorder rounded-sm shadow gap-2hover:scale-105 hover:border-2 hover:border-turquesaBtnBorder hover:bg-turquesaBtnBg hover:text-white  transition-transform duration-300 ease-in-out hover:shadow-[0_0_25px_5px_rgba(34,211,238,0.5)]',
        destructive:
      ...
      size: {
        default: 'h-12 w-65 p-5 has-[>svg]:px-3',
        secondary: 'h-9 w-35 has-[>svg]:px-3',
        sm: 'h-9 w-10 has-[>svg]:px-3',
